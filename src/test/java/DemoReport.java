...
public class DemoReport {
    ...
    public static void main(String[] args) throws Exception {
        ...
        createCheckupResultByTemplate_1(doc, param1);
        createCheckupResultByTemplate_2(doc, param2);
        try (FileOutputStream out = new FileOutputStream("D:/wordquxiaobo.docx");) {
            doc.write(out);
